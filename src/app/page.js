...
export default function RegisFormPage() {
  ...
  function computeTotalPayment() {
    ...
    if (buyCap) total += 400;
    total = buyBottle && buyCap && buyShoes ? total * 0.8 : total;
    return total;
  }
  ...
  return (
    <div className="mx-auto vstack gap-3" style={{ width: "400px" }}>
      ...
      <div>
        ...
        <div className="invalid-feedback" checked ={planError}>Please select a Plan</div>
      </div>
      ...
      <div>
        ...
        {buyBottle && buyCap && buyShoes && (<div className="text-success d-block">(20% Discounted)</div>)}
      ...
      <div>
        <input className="me-2" type="checkbox" onChange={cbAgree}checked={isUserAgreed}/>I agree to the terms and
        conditions
      </div>
